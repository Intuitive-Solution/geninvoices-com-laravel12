  ...
  'labels' => $this->mockTranslatedLabels(),
    ...
    private function mockTranslatedLabels()
    {
        return [
            ...
            '$task.service_label' => ctrans('texts.resource'),
            '$task.billable_time_label' => ctrans('texts.billable_time'),
            '$portalButton_label' => '',
            ...
            '$task.hours_label' => ctrans('texts.quantity'),
            ...
            '$task.rate_label' => ctrans('texts.unit'),
